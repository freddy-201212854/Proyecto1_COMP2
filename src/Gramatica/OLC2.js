...
*/
var OLC2 = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,5],$V1=[5,8],$V2=[1,12],$V3=[1,10],$V4=[1,11],$V5=[1,14],$V6=[1,15],$V7=[1,16],$V8=[1,17],$V9=[11,13,14,15,16],$Va=[11,13,14];
